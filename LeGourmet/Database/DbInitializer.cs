        ...
        public static void Seed(AppDbContext context)
        {
            if (!context.Recipes.Any())
            {
                ...
                (
                    ...
                    new Recipe { Name = "Breakfast", Description = "Delicious breakfast made with love", ImageUrl = "7" },
                    new Recipe { Name = "Main course", Description = "Delicious main course made with love", ImageUrl = "12" },
                    new Recipe { Name = "Soup", Description = "Delicious soup made with love", ImageUrl = "20" },
                    ...
                    new Recipe { Name = "Spices", Description = "Delicious main course made with love", ImageUrl = "2" },
